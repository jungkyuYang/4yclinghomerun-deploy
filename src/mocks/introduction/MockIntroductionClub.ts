...
export const IntroductionClubData: TIntroductionData[] = [
  {
    id: 'data1',
  ...
  },
  {
    ...
    img: 'https://www.ktwiz.co.kr/static/media/team_about_article_img_2.e8c98a30.png',
  },
  {
    id: 'data3',
    header: '복합 문화공간의 첨단 야구장!',
    ...
    img: 'https://www.ktwiz.co.kr/static/media/team_about_article_img_3.c764e4b8.png',
  },
  {
    id: 'data4',
    header: '재미와 즐거움을 추구하는 근성 있는 구단!',
    desc: '창단 과정에서 경기도민과 수원시민들이 보내주신 성원과 기대에 보답하기 위해 앞으로도 야구를 통한 즐거운 여가 문화를 제공할 것이며 팬들과 함께 할 수 있는 새롭고 다양한 마케팅을 전개해 나가 “재미와 즐거움을 추구하는 근성있는 구단”이라는 kt sports의 확고한 비전을 실행하고 다년간 쌓인 스포츠 구단 운영 노하우로 그라운드 안팎에서 그 동안 없던 새로운 야구를 kt wiz가 이루어 가겠습니다.',
  },
];
