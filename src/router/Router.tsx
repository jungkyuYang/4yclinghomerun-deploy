...
import GamePage from '@/pages/imsi/GamePage';
...
import TeamRankingPage from '@/pages/imsi/ranking/TeamRankingPage';
import PlayerRankingPage from '@/pages/imsi/ranking/PlayerRankingPage';
import CrowdRankingPage from '@/pages/imsi/ranking/CrowdRankingPage';
import RankingPage from '@/pages/imsi/RankingPage2';
...
import SchedulePage from '@/pages/imsi/SchedulePage';
import BoxScorePage from '@/pages/imsi/BoxScorePage';
import WatchPointPage from '@/pages/imsi/WatchPointPage';
